...
public class UserCreateRequestTest {
        ...
        public static final UserCreateRequest usrValidEmail6 = UserCreateRequest.builder() //
                        .email("usrValidEmail6@email.com.br").password("senha12345").isAdmin(false).build();
